...
#             WHERE  t_capture_cap.cap_id IN ( SELECT min(t_capture_cap_1.cap_id) AS min
...
#             LEFT JOIN v_posi_gpsgsm ON t_ani_gpsgsm.ani_id = v_posi_gpsgsm.ani_id AND t_ani_gpsgsm.cap_annee_suivi = v_posi_gpsgsm.cpos_annee_suivi
